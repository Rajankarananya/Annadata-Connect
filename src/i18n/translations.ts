...
export const translations: Record<LanguageCode, TranslationShape> = {
  en: {
    ...
    footerTagline: 'Empowering India\'s farmers with technology, fair prices, and direct market access since 2024.',
    ...
    footerRights: '© 2024 Annadata. All rights reserved.',
  ...
  hi: {
    ...
    footerTagline: 'भारत के किसानों को तकनीक, उचित मूल्य और सीधे बाजार तक पहुंच के साथ 2024 से सशक्त बना रहे हैं।',
    ...
    footerRights: '© 2024 अन्नदाता। सर्वाधिकार सुरक्षित।',
  ...
  mr: {
    ...
    footerTagline: 'भारताच्या शेतकऱ्यांना तंत्रज्ञान, योग्य दर आणि थेट बाजारपेठ प्रवेशासह 2024 पासून सक्षम करत आहोत.',
    ...
    footerRights: '© 2024 अन्नदाता. सर्व हक्क राखीव.',
