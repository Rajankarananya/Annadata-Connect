					...
					<div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
						...
						<div className="relative">
							<div className="flex w-full cursor-pointer items-center justify-between rounded-xl bg-surface-container-lowest px-4 py-3 font-medium text-stone-700">
								<span>{t('farmerClaims.allCrops')}</span>
					...
					<table className="w-full border-collapse text-left">
						<thead>
							<tr className="bg-surface-container-low/50">
								<th className="font-label px-8 py-5 text-xs font-bold uppercase tracking-widest text-stone-500">{t('farmerClaims.claimId')}</th>
								<th className="font-label px-8 py-5 text-xs font-bold uppercase tracking-widest text-stone-500">{t('farmerClaims.cropType')}</th>
								<th className="font-label px-8 py-5 text-xs font-bold uppercase tracking-widest text-stone-500">{t('farmerClaims.dateSubmitted')}</th>
								<th className="font-label px-8 py-5 text-xs font-bold uppercase tracking-widest text-stone-500">{t('farmerClaims.estValue')}</th>
								<th className="font-label px-8 py-5 text-xs font-bold uppercase tracking-widest text-stone-500">{t('farmerClaims.status')}</th>
								<th className="font-label px-8 py-5 text-xs font-bold uppercase tracking-widest text-stone-500">{t('farmerClaims.actions')}</th>
							</tr>
						</thead>
